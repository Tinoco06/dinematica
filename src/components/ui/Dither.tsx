...
// @ts-nocheck — Componente vendored de ReactBits (Three.js / R3F)
import { useRef, useEffect, forwardRef, lazy, Suspense, useState } from 'react'
...
const RetroEffect = forwardRef(function RetroEffect(props: { colorNum: number; pixelSize: number }, ref) {
